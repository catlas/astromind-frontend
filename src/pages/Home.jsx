...
const Home = () => {
  ...
  const handleAuth = async (e) => {
    ...
    try {
      ...
      const errorMessage = error.response?.data?.detail || error.message || 'Възникна грешка';
      alert(errorMessage);
    }
  };
    ...
    <div className="min-h-screen bg-[#0B0616] text-white font-display overflow-x-hidden antialiased">
      ...
      <header className="sticky top-0 z-50 flex items-center justify-between border-b border-white/5 bg-[#0B0616]/80 backdrop-blur-md px-6 py-4 md:px-10 lg:px-20">
        <div className="flex items-center gap-3 cursor-pointer" onClick={() => navigate('/dashboard')}>
          <div className="w-8 h-8 rounded-lg flex items-center justify-center text-[#6B46C1]">
        ...
        <div className="hidden lg:flex flex-1 justify-end items-center gap-8">
          ...
          <div className="flex items-center gap-4">
            ...
            <button 
              ...
              className="flex min-w-[84px] items-center justify-center rounded-md h-10 px-6 bg-[#6B46C1] hover:bg-[#553C9A] text-white text-sm font-bold transition-all shadow-[0_0_15px_rgba(107,70,193,0.3)]"
            >
              Регистрация
            </button>
          </div>
      ...
      <section className="relative px-6 py-12 md:py-20 lg:px-20 flex justify-center bg-[#0B0616] overflow-hidden min-h-[85vh] items-center">
        ...
        <div className="w-full max-w-[1280px] relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="flex flex-col text-left items-start">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#6B46C1]/10 border border-[#6B46C1]/20 w-fit mb-6 backdrop-blur-sm">
              <span className="material-symbols-outlined text-[#6B46C1] text-xs">auto_awesome</span>
              <span className="text-[#6B46C1] text-[10px] font-bold tracking-widest uppercase">AI-базирана астрология</span>
            </div>
            
            <h1 className="text-white text-5xl md:text-6xl lg:text-7xl font-bold leading-[1.1] tracking-tight mb-6">
              Твоят Личен AI<br/>
              Астролог.<br/>
              <span className="text-[#6B46C1] block">Дълбок.</span>
              <span className="text-[#6B46C1] block">Терапевтичен.</span>
            ...
            <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto mb-8">
              <button 
                onClick={() => { setShowAuth(true); setIsLogin(false); }}
                className="flex h-12 min-w-[180px] items-center justify-center rounded-lg bg-[#6B46C1] hover:bg-[#553C9A] px-6 text-white text-base font-bold transition-all shadow-[0_0_20px_rgba(107,70,193,0.4)]"
              >
                Безплатен Анализ
              </button>
            ...
            <div className="relative w-full p-8 z-10">
              <div className="bg-[#1a1625]/80 backdrop-blur-md p-6 rounded-xl border border-white/10 shadow-lg">
                <div className="flex gap-4 items-start">
                  <div className="w-12 h-12 rounded-full bg-[#6B46C1] flex items-center justify-center shrink-0 shadow-[0_0_10px_rgba(107,70,193,0.5)]">
                    <span className="material-symbols-outlined text-white text-2xl">auto_awesome</span>
                  </div>
                  <div className="flex flex-col gap-1">
                    <span className="text-[#6B46C1] text-xs font-bold uppercase tracking-wide">AstroMind AI</span>
        ...
        <div className="flex flex-col max-w-[1200px] flex-1">
          <div className="flex flex-col gap-10 py-10">
            <div className="flex flex-col gap-4 text-center items-center">
              <h2 className="text-[#6B46C1] font-bold tracking-wider uppercase text-sm">Космически Функции</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="group flex flex-col gap-4 rounded-xl border border-white/5 bg-[#13111C] p-6 hover:border-[#6B46C1]/50 transition-colors duration-300">
                <div className="w-12 h-12 rounded-lg bg-white/5 flex items-center justify-center text-[#6B46C1] group-hover:bg-[#6B46C1] group-hover:text-white transition-colors duration-300">
      ...
      <section className="relative px-6 py-16 lg:px-40 flex justify-center bg-[#0B0616] overflow-hidden" id="how-it-works">
        <div className="absolute top-0 right-0 w-1/2 h-full bg-gradient-to-l from-[#6B46C1]/5 to-transparent pointer-events-none"></div>
        <div className="flex flex-col max-w-[1200px] flex-1 relative z-10">
          <div className="flex flex-col gap-4 text-center items-center mb-16">
            <h2 className="text-[#6B46C1] font-bold tracking-wider uppercase text-sm">Услуги и Функции</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
            {/* Натална Карта (Lite) */}
            <div className="group relative flex flex-col gap-4 rounded-2xl border border-white/10 bg-[#13111C] p-6 hover:border-[#6B46C1]/50 hover:shadow-[0_0_20px_rgba(107,70,193,0.15)] transition-all duration-300">
            ...
            {/* Конкретен Въпрос */}
            <div className="group relative flex flex-col gap-4 rounded-2xl border border-white/10 bg-[#13111C] p-6 hover:border-[#6B46C1]/50 hover:shadow-[0_0_20px_rgba(107,70,193,0.15)] transition-all duration-300">
              <div className="absolute top-4 right-4 px-2 py-1 rounded-md text-[10px] font-bold bg-[#6B46C1]/20 text-[#6B46C1] border border-[#6B46C1]/20 uppercase tracking-wide flex items-center gap-1">
                <span className="material-symbols-outlined text-[12px]">monetization_on</span> Premium
              </div>
              <div className="w-12 h-12 rounded-xl bg-[#6B46C1]/10 flex items-center justify-center text-[#6B46C1] mb-2">
      ...
      <section className="relative px-6 py-16 lg:px-40 flex justify-center bg-[#0B0616]" id="pricing">
        <div className="flex flex-col max-w-[1000px] flex-1">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
            ...
            {/* Paid Tier */}
            <div className="relative flex flex-col p-8 rounded-2xl border border-[#6B46C1] bg-[#13111C] h-full shadow-[0_0_30px_rgba(107,70,193,0.15)]">
              <div className="absolute -top-3 right-8 bg-[#6B46C1] text-white text-xs font-bold px-3 py-1 rounded-full uppercase tracking-wider">
                Най-популярно
              </div>
              <div className="mb-4">
              ...
              <ul className="flex flex-col gap-4 mb-8 flex-1">
                <li className="flex items-center gap-3 text-white text-sm font-medium">
                  <span className="material-symbols-outlined text-[#6B46C1] text-lg">check</span>
              ...
              <button 
                ...
                className="w-full py-3 rounded-lg bg-[#6B46C1] text-white font-bold hover:bg-[#553C9A] transition-all shadow-lg"
              >
                Вземете AstroМонети
              </button>
            </div>
        ...
        <div className="max-w-[1200px] mx-auto flex flex-col md:flex-row justify-between gap-10">
          <div className="flex flex-col gap-4 max-w-[300px]">
            <div className="flex items-center gap-2">
              <span className="material-symbols-outlined text-[#6B46C1] text-2xl">auto_awesome</span>
          ...
          <div className="flex gap-10 md:gap-20 flex-wrap">
            <div className="flex flex-col gap-4">
              ...
              <a href="#features" className="text-slate-500 hover:text-[#6B46C1] text-sm transition-colors">Функции</a>
              <a href="#pricing" className="text-slate-500 hover:text-[#6B46C1] text-sm transition-colors">Цени</a>
              <a href="/buy-coins" className="text-slate-500 hover:text-[#6B46C1] text-sm transition-colors">AstroМонети</a>
            </div>
            <div className="flex flex-col gap-4">
              <h3 className="font-bold text-sm text-slate-300 uppercase tracking-wider">Компания</h3>
              <a href="#" className="text-slate-500 hover:text-[#6B46C1] text-sm transition-colors">За нас</a>
              <a href="#" className="text-slate-500 hover:text-[#6B46C1] text-sm transition-colors">Блог</a>
              <a href="#" className="text-slate-500 hover:text-[#6B46C1] text-sm transition-colors">Контакти</a>
            </div>
            <div className="flex flex-col gap-4">
              <h3 className="font-bold text-sm text-slate-300 uppercase tracking-wider">Правни</h3>
              <a href="#" className="text-slate-500 hover:text-[#6B46C1] text-sm transition-colors">Политика за поверителност</a>
              <a href="#" className="text-slate-500 hover:text-[#6B46C1] text-sm transition-colors">Общи условия</a>
            </div>
          </div>
        </div>
            ...
            <form onSubmit={handleAuth} className="space-y-4">
              {!isLogin && (
                <input 
                  type="text" 
                  placeholder="Име" 
                  className="w-full bg-[#0B0616] border border-white/10 p-3 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#6B46C1]"
                  value={fullName} 
              ...
              <button 
                type="submit"
                className="w-full bg-[#6B46C1] hover:bg-[#553C9A] py-3 rounded-lg font-bold transition-colors"
              >
                {isLogin ? 'Влез' : 'Регистрирай ме'}
              </button>
            </form>
            <div className="mt-4 text-center">
              <button 
                onClick={() => { setIsLogin(!isLogin); setEmail(''); setPassword(''); setFullName(''); }} 
                className="text-[#6B46C1] hover:text-purple-300 text-sm"
              >
